 ...
 */
public record ResolvedItem(ResourceLocation itemId, String customName, @Nullable TriggerType trigger,
        String layer, @Nullable ItemStack stack) {

    public ResolvedItem(ResourceLocation itemId, String customName, @Nullable TriggerType trigger, String layer) {
